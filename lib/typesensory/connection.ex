...
defmodule Typesensory.Connection do
  @moduledoc """
  Handle Tesla connections for Typesensory.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, Typesensory.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:typesensory, :base_url, @default_base_url)
      )
